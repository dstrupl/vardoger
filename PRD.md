...
- [x] Plugin packaging and marketplace submission for Claude Code — **Live** (2026-04-25) in the Claude Code Plugins directory (`plugins/claude-code/`); the [claude.ai plugin-submissions dashboard](https://claude.ai/settings/plugins/submissions) shows the Vardoger listing with a **Published** badge (submitted 2026-04-20)
